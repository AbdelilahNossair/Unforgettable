...
import { Calendar, Users, LogOut, Settings, Home, Menu, X, Sun, Moon, Camera } from 'lucide-react';
...
export const Layout: React.FC = () => {
  ...
  const { user, isDarkMode, toggleDarkMode, clearSession } = useAuthStore();
  ...
  const menuItems = [
    ...
    { path: '/photos', icon: Camera, label: 'Photos', roles: ['photographer', 'attendee'] },
